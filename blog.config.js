...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ethan', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '程序员，喜欢做东西', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.ethanzhou.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Ethan的博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个考研党,Hi，我是一个单身狗,欢迎来到我的博客🎉',
